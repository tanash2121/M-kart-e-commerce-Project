...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="vegetable.php">Vegetables</a>
  ...
  <form action="veg1orderform.php" method="post">
...
<form class="row g-3">
  ...
  <div class="col-md-2">
  <label for="v" class="form-label">Ladies finger Quantity</label>
  
  <select class="form-select"  name="l"  id="v" required>
    <option selected disabled value="">In Kg</option>
    <option>1</option>
    <option>2</option>
    <option>3</option>
    <option>4</option>
